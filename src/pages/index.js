          ...
          <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
            ...
            <div className="flex-1 px-3">
              <Card className="mb-8 h-full">
                ...
                <p className="mt-4">
                  ...
                  Cualquier acción consume mucho tiempo y es propensa al error humano. Además
                  requieren de un tercero. Al automatizar con blockchain removes intermediarios y
                  ganas tiempo
                </p>
              </Card>
            </div>
            <div className="flex-1 px-3">
              <Card className="mb-8 h-full">
                ...
                <p className="mt-4">
                  Para todas las organizaciones, reducir costos es una prioridad. Con blockchain no
              ...
              <Card className="mb-8 h-full ">
                ...
                >
                  <a style={{ color: 'black' }} href="https://recetas.polh.io/" target="_blank">
                    <Button className="colors.primary.darker mt-6  items-center">
                      Ir a Recetas
                    </Button>
                  </a>
                </div>
